...
<body>
    ...
    <% Library libr = (Library) request.getAttribute("Library"); %>
    ...
    <div class="container mt-5">
        ...
        <form action="update" method="post">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="id" value="<%= libr.getId() %>" placeholder="New Id"><br>
            </div>
            <div class="form-group">
                <label for="name">Name</label><br>
                <input type="text" class="form-control" name="name" value="<%= libr.getName() %>" placeholder="New Name"><br>
            </div>
            <div class="form-group">
                <label for="email">Email Address</label><br>
                <input type="email" class="form-control" name="email_address" value="<%= libr.getEmail_address() %>" placeholder="New Email"><br>
            </div>
            <div class="form-group">
                <label for="password">Password</label><br>
                <input type="password" class="form-control" name="password" value="<%= libr.getPassword() %>" placeholder="New Password"><br>
            </div>
            <div class="form-group">
                <label for="mobile">Mobile Number</label><br>
                <input type="number" class="form-control" name="mobile_number" value="<%= libr.getMobile_number() %>" placeholder="New Mobile Number"><br>
            </div>
