...
<body>
    ...
    <h1 class="display-4 text-center p-3 mb-5" style="background-color: rgba(255, 255, 255, 0.8);">Admin Section</h1>
    <!-- Rest of your content goes here -->

        
        <ul class="list-group">
            <li class="list-group-item"><a href="Addlibrarian">Add Librarian</a></li>
            <li class="list-group-item"><a href="viewlibrarian">View Librarian</a></li>
            <li class="list-group-item"><a href="viewlibrarian">Edit Librarian</a></li>
            <li class="list-group-item"><a href="viewlibrarian">Delete Librarian</a></li>
